...
![skills](https://skillicons.dev/icons?i=bash,debian,anaconda,windows,linux,kali,msfconsole,c,cpp,java,html,css,bootstrap,vercel,js,php,npm,postman,nodejs,mysql,py,pytorch,scikitlearn,tensorflow,docker,git,github,linkedin,cloudflare,jquery,vscode&theme=light)
