...
![skills](https://skillicons.dev/icons?i=bash,linux,kalilinux,hackthebox,tryhackme,c,cpp,java,html,css,bootstrap,js,php,nodejs,mysql,py,pytorch,scikitlearn,tensorflow,docker,git,github,cloudflare,jquery,vscode&theme=light)
