...
![skills](https://skillicons.dev/icons?i=bash,linux,c,cpp,java,html,css,bootstrap,js,php,nodejs,mysql,py,pytorch,scikitlearn,tensorflow,docker,git,cloudflare,jquery,vscode&theme=light)
