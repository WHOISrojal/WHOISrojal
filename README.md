...
![skills](https://skillicons.dev/icons?i=bash,linux,java,html,css,bootstrap,js,php,nodejs,mysql,py,pandas,pytorch,scikitlearn,seaborn,tensorflow,docker,git,cloudflare,jquery,vscode&theme=light)
