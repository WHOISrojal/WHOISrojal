...
![skills](https://skillicons.dev/icons?i=bash,linux,java,html,css,bootstrap,js,php,nodejs,mysql,py,pytorch,scikitlearn,seaborn,tensorflow,docker,git,cloudflare,jquery,vscode&theme=light)
